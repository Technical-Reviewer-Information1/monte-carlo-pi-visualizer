...
『大学入学共通テスト「情報Ⅰ」対策問題集』（技術評論社, ISBN 978-4-297-15084-6）pp.97-98 連動Webアプリ。

**公開URL**: https://technical-reviewer-information1.github.io/monte-carlo-pi-visualizer/

でたらめに点を打つだけで円周率が求まります。点の数を増やすほど精度が上がるようすを、自分の目で確かめましょう。
